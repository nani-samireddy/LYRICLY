...
function loadLanguages() {
    availableLanguages.forEach(element => {
        ...
        langugaesNamesContainerUL.innerHTML = langugaesNamesContainerUL.innerHTML + `  <a href="/docs/Languages/${element}/${element}Index.html"><li class="cursor-pointer rounded-xl p-4 hover:bg-green-200 ${selected}"><span>${element}</span> </li></a>`;
    });
}
